...
public class ThreeBallAutoDCMP {
    ...
    public static double feedShooterTime = 1.25;
    ...
    public static double driveBackwardsSpeed = -0.4;
    ...
    public static double pauseDriveTime = 0.5;
    ...
    public static double driveToShootSpeed = 0.4;
    ...
    public static double feedSecondBallTime = 1.25;
    ...
    public Command pauseDriveThirdCargo; 
    public double initialPauseDriveThirdCargo; 
    public boolean pauseDriveThirdCargoFinished = false; 
    public static double pauseDriveThirdCargoTime = 0.5;
    ...
    public static double feedThirdBallTime = 1.25;
    public boolean feedThirdBallFinished = false; 

    public Command setThirdShooterRPM;
    public boolean setThirdShooterRPMFinished; 
    public static double setThirdShooterRPMTime = 1.0; 
    public double initialSetThirdShooterRPMTime; 
     ...
     */
    public ThreeBallAutoDCMP(Drivetrain drivetrain, Shooter shooter, ShooterFeederSubsystem shooterFeeder, 
        ...
        this.pauseDriveThirdCargo = new FunctionalCommand(() -> {
            this.initialPauseDriveThirdCargo = Timer.getFPGATimestamp(); 
        }, () -> {
            if (Timer.getFPGATimestamp() - this.initialPauseDriveThirdCargo >= pauseDriveThirdCargoTime) {
                this.pauseDriveThirdCargoFinished = true; 
            } else {
                this.drivetrain.arcadeDrive(0, 0); 
                this.shooterFeeder.setRollSpeed(pauseDriveRollSpeed);
            }
            ...
            this.drivetrain.arcadeDrive(0, 0); 
            this.shooterFeeder.setRollSpeed(0);
        } , () -> this.pauseDriveThirdCargoFinished, this.drivetrain);
        ...
        this.setThirdShooterRPM = new FunctionalCommand(() -> {
            this.shooter.setVelocity(shooterTargetRPM);
            this.initialSetThirdShooterRPMTime = Timer.getFPGATimestamp(); 
        }, () -> {
            if (Timer.getFPGATimestamp() - this.initialSetThirdShooterRPMTime >= setThirdShooterRPMTime) {
